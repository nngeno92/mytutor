...
namespace mytutor.Services
{
    public class ApiService
    {
        public async Task<bool> RegisterUser(string email, string password, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("https://mytutor92.azurewebsites.net/api/Account/Register", content);
        ...
        public async Task<TokenResponse> GetToken(string email, string password)
        {
            ...
            var response = await httpClient.PostAsync("https://mytutor92.azurewebsites.net//Token", content);
        ...
        public async Task<bool> PasswordRecovery(string email)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            var response = await httpClient.PostAsync("https://mytutor92.azurewebsites.net/api/Users/PasswordRecovery", content);
        ...
        public async Task<bool> ChangePassword(string oldPassword, string newPassword, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("https://mytutor92.azurewebsites.net/api/Account/ChangePassword", content);
        ...
        public async Task<bool> BecomeAnInstructor(Instructor instructor)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.PostAsync("https://mytutor92.azurewebsites.net/api/instructors", content);
        ...
        public async Task<List<Instructor>> GetInstructors()
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.GetStringAsync("https://mytutor92.azurewebsites.net/api/instructors");
        ...
        public async Task<Instructor> GetInstructor(int id)
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.GetStringAsync("https://mytutor92.azurewebsites.net/api/instructors/" + id );
        ...
        public async Task<List<Instructor>> SearchInstructors(string subject, string gender, string city)
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesstoken", ""));
            var response = await httpClient.GetStringAsync("https://mytutor92.azurewebsites.net/api/instructors?subject="+subject + "&gender=" + gender + "&city=" + city);
            return JsonConvert.DeserializeObject<List<Instructor>>(response);
        }
        ...
        public async Task<List<City>> GetCities()
        {
            ...
            var response = await httpClient.GetStringAsync("https://mytutor92.azurewebsites.net/api/cities");
        ...
        public async Task<List<Courses>> GetCourses()
        {
            ...
            var response = await httpClient.GetStringAsync("https://mytutor92.azurewebsites.net/api/courses");
